      ...
      "allOf": [
        ...
        },
        {
          ...
          "properties": {
            ...
            "login": {
              "type": "string",
              "description": "The username required to connect to the Docker hub, private registry or GCR."
            },
            "password": {
              "type": "string",
              "description": "The password required to connect to the Docker hub, private registry or GCR."
            },
            "registry": {
              "type": "string",
              "description": "The url to the Docker registry or GCR."
            },
            "integration": {
              "type": "string",
              "description": "The ID of the integration. Required for using the image from the Amazon ECR."
            },
            "region": {
              "type": "string",
